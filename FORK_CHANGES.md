...
| `dsh-better-sidebar@^0.16.1`、`@liustack/modlens@^3.25.0`、`dsh-builtin-browser@^0.1.17`、`@memtensor/memos-local-plugin@^2.0.17`、`dsh-client-auto-continue@^0.8.1` | runtime 装入 bind 目录（dsh-market，2026-08-30 前后加） | 当前在装社区插件，版本见 profiles/web/package.json |
